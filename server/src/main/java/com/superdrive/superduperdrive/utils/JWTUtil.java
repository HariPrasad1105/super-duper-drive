package com.superdrive.superduperdrive.utils;
...
public class JWTUtil {
    private static final String SECRET_KEY = "SuperDuperDriveApplicationKey";

    public String generateToken(UserProfile userProfile) {
        Map<String, Object> claims = new HashMap<>();
        return createToken(claims, userProfile.getUsername());
    }
